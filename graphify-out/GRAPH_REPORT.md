...
### Community 1 - "SwiftUI"
Cohesion: 0.05
Nodes (39): App, PharmaShiftApp, CaptureView, FocusField, scientific, trade, unknownLabel, SaveAction (+31 more)
...
### Community 5 - "Chapter"
Cohesion: 0.09
Nodes (23): AboutView, AppNavigation, AppShell, AppTab, capture, home, library, more (+15 more)
...
Cohesion: 0.11
Nodes (11): CoreTransferable, Foundation, Observation, AppTheme, Color, PrivacyValidator, Bool, ReportFile (+3 more)
...
Cohesion: 0.13
Nodes (11): ModelContainer, PharmaShift, DrugFilter, Bool, Calendar, Date, ModelAndPersistenceTests, ReportBuilderTests (+3 more)

### Community 22 - "LibraryView"
Cohesion: 0.19
Nodes (7): Hashable, ModelContext, LibraryView, Int, PracticeCase, StarterContent, Int
...
## Knowledge Gaps
- **113 isolated node(s):** `home`, `library`, `capture`, `practice`, `more` (+108 more)
...
- **Why does `String` connect `String` to `ShiftLog`, `SwiftUI`, `Drug`, `ImageCapture.swift`, `Chapter`, `QuestionType`, `LibraryView`, `PracticeSessionView`, `ShiftView`, `Identifiable`, `SafetyFlag`, `DosingFrequency`, `HalfLifeBand`, `CaseIterable`, `Codable`, `ConfidenceLevel`, `DurationBand`, `OnsetBand`, `LibraryView`, `ReportEditorView`?**
  _High betweenness centrality (0.305) - this node is a cross-community bridge._
- **Why does `Drug` connect `ShiftLog` to `SwiftUI`, `Drug`, `ImageCapture.swift`, `String`, `Chapter`, `QuestionType`, `PracticeSessionView`, `ShiftView`, `Identifiable`, `SafetyFlag`, `DosingFrequency`, `HalfLifeBand`, `CaseIterable`, `Codable`, `ConfidenceLevel`, `DurationBand`, `OnsetBand`, `ModelAndPersistenceTests`, `LibraryView`?**
  _High betweenness centrality (0.245) - this node is a cross-community bridge._
- **Why does `Chapter` connect `Chapter` to `ShiftLog`, `SwiftUI`, `Drug`, `String`, `LibraryView`, `PracticeSessionView`, `ShiftView`, `Identifiable`, `CaseIterable`, `Codable`?**
